...
const Favorites = () => {
  ...
  const favoriteHeadphones = headphones?.filter((i) => i.isFavorite);
  const favoriteAirphones = airphones?.filter((i) => i.isFavorite);

  const noHeadphonesFavorites =
    favoriteHeadphones?.length === 0 || !favoriteHeadphones;
  const noAirphonesFavorites =
    favoriteAirphones?.length === 0 || !favoriteAirphones;
  return (
    <div className="conatiner mx-auto mb-[41px]">
      {!noHeadphonesFavorites ? (
      ...
      {noAirphonesFavorites && noHeadphonesFavorites && (
        <h2 className="text-[#838383] text-5xl leading-6 font-semibold mt-32 mb-5">
